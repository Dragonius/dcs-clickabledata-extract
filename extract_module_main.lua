...
--Not working Ka-50_3, Problem with clickabledata.lua

--Not working AV8BNA, Wrong location clickabledata.lua ->  \Cockpit\  * FIXED 22.1.2023 * 
--Not working M-21bis, Wrong location clickabledata.lua ->  \Cockpit\  * FIXED 22.1.2023 * 
...
local function file_exists(name)
	...
	if f~=nil then 
			--print(name, "\n test")
			io.close(f)
		--print("still work", module_name, dcs_install_path)
